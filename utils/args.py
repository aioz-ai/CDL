...
def parse_args(args_list=None):
    ...
    parser.add_argument(
        ...
        help='name of experiment, possible: driving_carla, driving_gazebo, driving_udacity',
        type=str)
    parser.add_argument(
        '--network_name',
        choices=['gaia', 'amazon_us', 'exodus'],
        help='name of the network; possible: gaia, amazon_us, exodus',
        type=str
    )
    parser.add_argument(
        '--architecture',
